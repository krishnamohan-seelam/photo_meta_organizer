...
@pytest.mark.parametrize(
    "start", ["2026-01-01", "2026-01-01T00:00:00", "2026-01-01T00:00:00Z", "2026-01-01T00:00:00+02:00"]
)
def test_search_accepts_any_bound_format(client, start):
    resp = client.post("/api/search", json={"date_start": start, "date_end": "2026-12-31T00:00:00Z"})
